...
public class AbundantIcon implements GuiIcon {
    private static final MiniMessage SERIALIZER = ComponentService.MINI_MESSAGE;
    ...
    private AbundantIcon(Icon icon) {
        this.icon = icon;
    }

    public static AbundantIcon fromIcon(Icon icon) {
        return new AbundantIcon(icon);
    }
     ...
     */
    @Nonnull
    public AbundantIcon setLore(final Component... lore) {
     ...
     */
    @Nonnull
    public AbundantIcon setLore(final List<Component> lore) {
     ...
     */
    @Nonnull
    public AbundantIcon setName(final Component name) {
        final ItemMeta meta = icon.getItem().getItemMeta();
        if (meta == null) return this;
     ...
     */
    @Nonnull
    public AbundantIcon appendLore(final Component... newLines) {
     ...
     */
    @Nonnull
    public AbundantIcon appendLore(final List<Component> lore) {
        final ItemMeta meta = icon.getItem().getItemMeta();
        if (meta == null) return this;
     ...
     */
    @Nonnull
    public AbundantIcon insertLore(final int index, final Component... newLines) {
     ...
     */
    @Nonnull
    public AbundantIcon insertLore(final int index, final List<Component> newLines) {
        final ItemMeta meta = icon.getItem().getItemMeta();
        if (meta == null) return this;
     ...
     */
    @Nonnull
    public AbundantIcon setDurability(final short newDamage) {
     ...
     */
    @Nonnull
    public AbundantIcon setDurability(final int newDamage) {
     ...
     */
    @Nonnull
    public AbundantIcon setAmount(final int amount) {
     ...
     */
    @Nonnull
    public AbundantIcon hideFlags(final ItemFlag... itemFlag) {
     ...
     */
    @Nonnull
    public AbundantIcon enchant(final Enchantment enchantment) {
     ...
     */
    @Nonnull
    public AbundantIcon enchant(final Map<Enchantment, Integer> enchantments) {
     ...
     */
    @Nonnull
    public AbundantIcon enchant(final Enchantment enchantment, final int level) {
    ...
    @Nonnull
    public AbundantIcon onClick(Consumer<InventoryClickEvent> clickAction) {
    ...
    @Nonnull
    public AbundantIcon onDrag(Consumer<InventoryDragEvent> dragAction) {
